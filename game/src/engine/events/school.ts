    ...
    choices: [
      {
        ...
        memorySlotDraft: {
          ...
          importance: 4,
          toneTag: 'warm',
          recallText: '도서관 창가, 유나가 추천한 책 제목을 종이 끝에 적던 순간.',
          npcIds: ['yuna'],
        },
      },
      {
    ...
    choices: [
      ...
      },
      {
        ...
        memorySlotDraft: {
          ...
          importance: 5,
          toneTag: 'resolve',
          recallText: '수빈이 앞에서 설명하던 날, 내 목소리가 낯설게 단단했다.',
          npcIds: ['subin'],
        },
      },
      {
...
export const SCHOOL_MIDDLE_HIGH = [
  ...
  // ===== 초등 2학기 시작 (Y1 W26) — class-president-2(W25, 매년)와 경합하지 않게 한 주  mobil.
