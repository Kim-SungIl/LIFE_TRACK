  ...
  },
  {
    ...
    choices: [
      { text: '"선배한테 딱 맞는 것 같아" — 응원한다', effects: { social: 2, mental: 3 },
        npcEffects: [{ npcId: 'haeun', intimacyChange: 6 }],
        // 원래 "선배가 저한테 그랬잖아요. 들어주는 것만으로도 다르다고."였는데, 하은이 그런 말을 한
        // 선행 이벤트가 없다(미출처 인용). 게다가 하은은 첫 만남에서 "존댓말 하지 마"라고 했고
        // 다른 하은 선택지는 전부 반말이다 → 관찰로 바꾸고 반말로 맞춘다.
        message: '하은이가 웃었다. "진짜? 엄마는 뭔 상담사냐고 했는데..." "선배 남 얘기 들어주는 거 잘하잖아. 나도 그래서 편했어." 하은이 눈이 살짝 젖었다.' },
