    ...
    choices: [
      {
        ...
        memorySlotDraft: { category: 'reconciliation', importance: 8, toneTag: 'warm', recallText: '각자의 하늘로 간다며, 수빈이가 가로등 아래서 웃었다.', npcIds: ['subin'] },
      },
      {
        ...
        memorySlotDraft: { category: 'reconciliation', importance: 7, toneTag: 'melancholy', recallText: '아쉽다는 말끝에, 어디서든 연락하겠다던 수빈이.', npcIds: ['subin'] },
      },
    ],
  },
