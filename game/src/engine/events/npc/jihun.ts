    ...
    choices: [
      {
        ...
        memorySlotDraft: { category: 'reconciliation', importance: 8, toneTag: 'warm', recallText: '옥상 바람 속에서, 계속 친구하자고 약속했다.', npcIds: ['jihun'] },
      },
      {
        ...
        memorySlotDraft: { category: 'reconciliation', importance: 8, toneTag: 'warm', recallText: '너 없으면 재미없었을 거라 하자, 지훈이 괜히 먼 데를 봤다.', npcIds: ['jihun'] },
      },
    ],
  },
