    ...
    choices: [
      {
        ...
        memorySlotDraft: { category: 'growth', importance: 8, toneTag: 'breakthrough', recallText: '이겨낸 사람의 웃음으로, 유나가 음대를 택했다고 했다.', npcIds: ['yuna'] },
      },
      {
        ...
        memorySlotDraft: { category: 'reconciliation', importance: 7, toneTag: 'warm', recallText: '연주회에 꼭 오라며, 유나가 새끼손가락을 걸었다.', npcIds: ['yuna'] },
      },
    ],
  },
