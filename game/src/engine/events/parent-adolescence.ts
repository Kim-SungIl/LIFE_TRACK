...
export const ADOLESCENCE_EVENTS: GameEvent[] = [
  {
    ...
    choices: [
      ...
      {
        text: '"…몰라요. 저도 왜 이러는지 모르겠어요." 솔직히 말한다',
        effects: { mental: 1 },
        parentEffect: { baseDelta: 1.0, tag: 'shareWorry' },
        message: '엄마는 잠깐 말이 없다가, "그래, 그럴 때지" 했다.',
        // 아직 화해가 아니라 골짜기 속에서 마음을 연 순간 → growth. 회상이 growth(Y3)→reconciliation(Y5) 곡선으로 드러나고
        // 4C 설득(reconciliation) 회상과 cap 경합도 줄어 Y3 흔적 유실을 막는다.
        memorySlotDraft: {
          category: 'growth', importance: 5, toneTag: 'warm',
          recallText: '나도 내 마음을 잘 모르겠다고, 솔직히 말한 날.',
        },
      },
    ],
  },
