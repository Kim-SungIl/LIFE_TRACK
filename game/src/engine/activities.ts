...
export const ACTIVITIES: Activity[] = [
  // === 공부 계열 ===
  {
    id: 'self-study', name: '독학', slots: 1, fatigue: 6,
    effects: { academic: 2 }, moneyCost: 0, category: 'study',
    description: '혼자서 묵묵히 공부한다.',
    flavor: '조용히 책상에 앉아 진도를 뺀다. 집중이 잘 되는 날도 있고, 아닌 날도 있다.',
    tags: ['집중', '혼자', '꾸준함'],
  },
  {
    id: 'academy', name: '학원 수업', slots: 1, fatigue: 8,
    effects: { academic: 3 }, moneyCost: 3, category: 'study',
  ...
  {
    id: 'study-group', name: '스터디 그룹', slots: 1, fatigue: 5,
    effects: { academic: 2, social: 1 }, moneyCost: 0, category: 'study',
    description: '친구들과 함께 공부한다.',
    flavor: '카페에 모여 각자 공부하다가, 모르는 거 있으면 물어본다. 은근 효율적.',
    tags: ['친구', '협동', '변수 있음'],
  },
  {
    id: 'internet-lecture', name: '인강 시청', slots: 1, fatigue: 5,
    effects: { academic: 2 }, moneyCost: 1, category: 'study',
  ...
  {
    id: 'reading', name: '독서', slots: 1, fatigue: 3,
    effects: { academic: 1, talent: 1, mental: 1 }, moneyCost: 0, category: 'study',
    description: '책을 읽으며 여유를 즐긴다.',
    flavor: '좋아하는 책에 빠져든다. 공부는 아니지만, 뭔가 머릿속이 넓어지는 기분.',
    tags: ['여유', '멘탈 회복', '다재다능'],
  },
  {
    id: 'library', name: '도서관 자습', slots: 1, fatigue: 4,
    effects: { academic: 1.5, mental: 1 }, moneyCost: 0, category: 'study',
  ...
  // === 운동 계열 ===
  {
    ...
    effects: { health: 2, mental: 2 }, moneyCost: 0, category: 'exercise',
    description: '산책, 조깅 등으로 기분 전환.',
    flavor: '동네 한 바퀴를 뛴다. 바람이 시원하다. 머리가 맑아지는 느낌.',
    tags: ['가벼움', '기분 전환', '멘탈 회복'],
  },
  {
    id: 'school-sports', name: '학교 체육부', slots: 1, fatigue: 10,
    effects: { health: 4, talent: 2, social: 1 }, moneyCost: 0, category: 'exercise',
    description: '방과후 체육부 활동.',
    flavor: '운동장에서 땀을 흘린다. 힘들지만, 같이 뛰는 애들이 있으니 버틸 만하다.',
    tags: ['고효율', '고피로', '친구', '활동적'],
  },
  {
    id: 'gym', name: '헬스/PT', slots: 1, fatigue: 8,
    effects: { health: 3, mental: 1 }, moneyCost: 2, category: 'exercise',
  ...
  // === 관계 계열 ===
  {
    ...
    effects: { social: 3, mental: 4 }, moneyCost: 1, category: 'social',
  ...
  },
  {
    ...
    effects: { social: 2, mental: -1 }, moneyCost: 0, category: 'social',
    description: '온라인에서 친구들과 소통한다.',
    flavor: '피드를 넘기다 보니 한 시간이 지났다. 재밌긴 한데... 좀 허무하다.',
    tags: ['간편', '인기 상승', '멘탈 주의'],
  },
  {
    id: 'club', name: '동아리 활동', slots: 1, fatigue: 5,
  ...
  // === 자기계발 계열 ===
  {
    id: 'art-lesson', name: '예체능 레슨', slots: 1, fatigue: 7,
  ...
  {
    id: 'creative', name: '창작 활동', slots: 1, fatigue: 4,
    effects: { talent: 2, mental: 2 }, moneyCost: 0, category: 'talent',
    description: '글쓰기, 그림, 작곡 등에 몰두한다.',
    flavor: '좋아하는 것에 빠져들면 시간 가는 줄 모른다. 이게 나만의 세계.',
    tags: ['자유', '멘탈 회복', '표현'],
  },
  {
    id: 'coding', name: '코딩 독학', slots: 1, fatigue: 6,
    effects: { academic: 1, talent: 2 }, moneyCost: 0, category: 'talent',
    description: '프로그래밍을 독학한다.',
    flavor: '코드가 돌아가는 순간의 쾌감. 에러가 나면 답답하지만, 그것도 배움이다.',
    tags: ['미래형', '논리적', '성취감'],
  },
  {
    id: 'volunteer', name: '봉사 활동', slots: 1, fatigue: 5,
    effects: { social: 2, mental: 2 }, moneyCost: 0, category: 'social',
  ...
  // === 휴식 계열 ===
  {
    ...
    effects: { mental: 3, health: 1 }, moneyCost: 0, category: 'rest',
  ...
  },
  {
    ...
    effects: { mental: 8, health: 2 }, moneyCost: 0, category: 'rest',
  ...
  // === 부모 전용 ===
  {
    ...
    effects: { academic: 2, mental: 1 }, moneyCost: 0, category: 'parent',
  ...
  },
  {
    ...
    effects: { mental: 3 }, moneyCost: 0, category: 'parent',
  ...
  // === 알바 ===
  {
    ...
    effects: { social: 1, mental: -1 }, moneyCost: -3,
    category: 'work',
