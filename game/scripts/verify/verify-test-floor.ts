...
//   · `"test": "true"` — 스위트가 통째로 안 돈다. 모든 게이트가 rc=0
//   · `vite.config.ts`의 `include`를 한 줄 좁히기 — **절반 가까이가 무음으로 빠진다**
//     (2026-09-11 실측: 93파일 1074개 → 50파일 628개. 절대 수치는 테스트가 늘면 달라지니
//      요점은 비율로 읽을 것 — 이 게이트는 수치가 아니라 파일 집합을 대조한다).
