 ...
 * (정적으로 가를 수 있는 (a)(b) 10종에 `invalid`를 표시하고, (c)만 해당하는 4종은 매주 계측으로 잡는다).
 ...
 * 93판(3시드)에서 (a)(b)를 빼면 번아웃 24.7 → 14.3%, S 67.7 → 71.4%다(63판 실측; (c)까지 빼면
 * 51판에서 11.8% / 70.6%) — 위반 표본이 헤드라인을
